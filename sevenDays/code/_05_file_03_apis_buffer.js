...
console.log( 'bin.slice(2):',bin.slice(2) );
...
bin.copy(dup);
console.log('dup:', dup); // => <Buffer 68 65 65 6c 6f>
dup[0] = 0x48;
console.log('bin:', bin); // => <Buffer 68 65 6c 6c 6f>
console.log('dup:', dup); // => <Buffer 48 65 65 6c 6f>
